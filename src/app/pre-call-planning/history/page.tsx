  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        const response = await fetch("/api/pre-call-planning/versions");
        ...
        {versions.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Generate your pre-call planning process to see history here.
            </p>
            <Link
              href="/pre-call-planning"
          ...
          <div className="space-y-4">
            {versions.map((version, index) => (
              <Link
                key={version.id}
                href={`/pre-call-planning?version=${version.id}`}
