      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Sales Motion History</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">{collections.length} analysis{collections.length !== 1 ? "es" : ""}</p>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">Analyze your first set of deals to see them here.</p>
            <Link
