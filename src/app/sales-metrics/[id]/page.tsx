  ...
  if (!assessment) {
    return (
      <>
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            <p className="text-gray-600 dark:text-gray-300 mb-4">Assessment not found.</p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/sales-metrics/history" className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 flex items-center gap-1">
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          {assessment.analysisReport && (
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Analysis Report</h2>
              <div
          ...
          {assessment.categories && assessment.categories.length > 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
              <div className="bg-gray-50 px-6 py-3 border-b border-gray-200 dark:border-gray-700">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Your Responses</h2>
              </div>
              <div className="divide-y divide-gray-100">
                {assessment.categories.map((cat) => (
                  <div key={cat.name}>
                    <div className="px-6 py-2 bg-gray-50/50">
                      <h3 className="text-sm font-medium text-gray-600 dark:text-gray-300">{cat.name}</h3>
                    </div>
                    {cat.questions.map((q) => (
                      <div key={q.questionId} className="px-6 py-3 flex items-start justify-between gap-4">
                        ...
                        <div className="text-sm font-medium text-gray-900 dark:text-gray-100 text-right shrink-0">
