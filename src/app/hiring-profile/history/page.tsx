      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">AE Hiring Profile History</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mb-6">Generate your first AE Hiring Profile to see it here.</p>
            <Link
