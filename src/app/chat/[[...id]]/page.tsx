              ...
              {messages.map((msg) => (
                <div key={msg.id}>
                  {msg.role === "USER" ? (
                    ...
                    <div className="prose prose-xl max-w-none prose-p:my-2 prose-headings:my-3 prose-ul:my-2 prose-ol:my-2 prose-li:my-0 prose-hr:my-4 mt-4">
            ...
            <form onSubmit={handleSendMessage} className="max-w-[800px] mx-auto">
              <div className="flex gap-4 items-end">
                <textarea
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none min-h-[56px] max-h-[200px] text-xl"
                  disabled={sending}
                  rows={1}
                  style={{ height: 'auto' }}
                  onInput={(e) => {
