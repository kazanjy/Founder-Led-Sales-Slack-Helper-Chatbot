      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-5xl mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Sales Deck History</h1>
                  ...
                  <div>
                    ...
                    {version.sourcePdfName && (
                      <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 line-clamp-1">
                        <span className="font-medium text-gray-600 dark:text-gray-300">Source:</span> {version.sourcePdfName}
                      </p>
                    )}
