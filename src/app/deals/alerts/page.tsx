            ...
            {kinds.map((k) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* left-0 anchors the knob to the pill's left edge —
                        without it, absolute positioning falls back to the
                        button's CENTERED static position and the white
                        knob renders outside the pill (invisible on the
                        white card). */}
                    <span
