...
export async function POST(request: NextRequest) {
  try {
    ...
    const validTypes = ["salesNarrative", "discoveryQuestions", "firstCallChecklist", "preCallPlanning", "preCallResearch", "emailSequence", "linkedInSequence", "callReview", "coldCallScript"];
