...
export default async function Home({ searchParams }: HomeProps) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      {/* Footer */}
      <footer className="py-8 pb-28 px-6 bg-gray-900 text-gray-400">
      ...
      {/* Floating CTA Bar */}
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-gray-200 py-4 px-6 z-50">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row gap-3 justify-center items-center">
          <a
            href="/api/slack/oauth"
            className="inline-flex items-center justify-center gap-2 bg-[#4A154B] hover:bg-[#3a1139] text-white font-semibold py-2.5 px-6 rounded-lg transition-colors shadow-md text-sm"
          >
          ...
          <a
            href="/api/auth/slack"
            className="inline-flex items-center justify-center gap-2 bg-white border-2 border-gray-300 text-gray-700 hover:border-gray-400 hover:bg-gray-50 font-semibold py-2.5 px-6 rounded-lg transition-colors text-sm"
          >
            Sign in with Slack
          </a>
        </div>
