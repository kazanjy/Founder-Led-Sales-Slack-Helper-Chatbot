      ...
      <section className="pt-16 pb-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-6 mb-4">
            {/* Primary CTA - Add to Slack for workspace admins */}
            <a
            ...
            <div className="flex flex-col items-center gap-3">
              <p className="text-sm text-gray-500">Or sign up to use the web app:</p>
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  href="/api/auth/google"
                  className="inline-flex items-center justify-center gap-2 bg-white border-2 border-gray-300 text-gray-700 hover:border-gray-400 hover:bg-gray-50 font-semibold py-3 px-6 rounded-lg transition-colors"
                >
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col items-center gap-3">
              <p className="text-blue-100 text-sm">Or sign up for the web app:</p>
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  href="/api/auth/google"
                  className="inline-flex items-center justify-center gap-2 bg-white text-gray-700 font-semibold py-2 px-6 rounded-lg hover:bg-blue-50 transition-colors"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                    <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                ...
                <a
                  href="/api/auth/slack"
                  className="inline-flex items-center justify-center gap-2 bg-transparent border-2 border-white text-white font-semibold py-2 px-6 rounded-lg hover:bg-white/10 transition-colors"
                >
                  Sign up with Slack
                </a>
              </div>
