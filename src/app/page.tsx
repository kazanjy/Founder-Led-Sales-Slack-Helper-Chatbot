...
export default async function Home({ searchParams }: HomeProps) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="pt-12 pb-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-500 mb-8 max-w-2xl mx-auto">
            Build your complete sales playbook, research prospects, review calls, generate outreach sequences,
            and get ongoing coaching &mdash; all based on Pete Kazanjy&apos;s <em>Founding Sales</em> methodology.
          </p>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="hidden md:block absolute top-12 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-purple-200 via-blue-200 to-green-200" />

            <div className="grid md:grid-cols-5 gap-6">
              {/* Step 1 */}
              <div className="text-center relative">
                <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-purple-100 to-purple-50 rounded-2xl flex items-center justify-center border border-purple-200 relative z-10">
                  <svg className="w-10 h-10 text-purple-600" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2L14.09 8.26L20 9.27L15.55 13.97L16.91 20L12 16.9L7.09 20L8.45 13.97L4 9.27L9.91 8.26L12 2Z" />
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-900 mb-1">GTM Assessment</h3>
                <p className="text-xs text-gray-500">Evaluate your go-to-market maturity across key dimensions</p>
              </div>

              {/* Step 2 */}
              <div className="text-center relative">
                <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl flex items-center justify-center border border-blue-200 relative z-10">
                  <svg className="w-10 h-10 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-900 mb-1">Sales Narrative</h3>
                <p className="text-xs text-gray-500">Generate your compelling product story and positioning</p>
              </div>

              {/* Step 3 */}
              <div className="text-center relative">
                <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-green-100 to-green-50 rounded-2xl flex items-center justify-center border border-green-200 relative z-10">
                  <svg className="w-10 h-10 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-900 mb-1">Discovery Questions</h3>
                <p className="text-xs text-gray-500">Craft questions that uncover real pain and urgency</p>
              </div>

              {/* Step 4 */}
              <div className="text-center relative">
                <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-orange-100 to-orange-50 rounded-2xl flex items-center justify-center border border-orange-200 relative z-10">
                  <svg className="w-10 h-10 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-900 mb-1">First Call Checklist</h3>
                <p className="text-xs text-gray-500">Know exactly what to cover on every first call</p>
              </div>

              {/* Step 5 */}
              <div className="text-center relative">
                <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-teal-100 to-teal-50 rounded-2xl flex items-center justify-center border border-teal-200 relative z-10">
                  <svg className="w-10 h-10 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-900 mb-1">Pre-Call Checklist</h3>
                <p className="text-xs text-gray-500">Build a personalized prep framework for every meeting</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 border border-blue-100">
              ...
              <ul className="text-sm text-gray-600 space-y-2 mb-6">
                <li className="flex items-center gap-2">
                  ...
                  Sales narrative, discovery questions, call checklists
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Pre-call research, call review, cold call scripts, sales decks
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Email &amp; LinkedIn sequences, sales metrics analysis
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Coaching history, progress tracking &mdash; web or Slack
                </li>
              </ul>
              <a
                href="/signin"
      ...
      {/* Real Tools Section - replaces generic use cases */}
      <section className="py-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4 text-gray-900">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <span className="text-xs text-orange-600 font-medium">Tailored to your ICP</span>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Generate structured sales presentation outlines from scratch, or upload an existing deck for AI-powered enhancement.
              </p>
              <span className="text-xs text-amber-600 font-medium">Fresh or enhance existing</span>
            </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Build your playbook, research prospects, review calls, and get ongoing coaching &mdash; all in one place.
          </p>
