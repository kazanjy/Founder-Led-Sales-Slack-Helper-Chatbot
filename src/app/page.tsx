      ...
      <section className="pt-12 pb-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-2">
            Your AI-powered Founder-Led Sales Coach
          </p>
          <p className="text-lg text-gray-500 mb-8 max-w-2xl mx-auto">
            Get a personalized GTM assessment and ongoing guidance based on Pete Kazanjy&apos;s <em>Founding Sales</em> methodology.
            From finding your first customers to scaling your sales team.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 border border-blue-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Ongoing Sales Coach</h3>
              <p className="text-gray-600 mb-4">
                Chat with Mikey anytime you need advice &mdash; on the web or in Slack. Get instant answers to your founder-led sales questions.
              </p>
              <ul className="text-sm text-gray-600 space-y-2 mb-6">
                <li className="flex items-center gap-2">
                  ...
                  Help with emails, calls, demos, objections
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Pricing, packaging, negotiation advice
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Take the GTM Assessment for personalized recommendations, or start chatting with Mikey now.
          </p>
